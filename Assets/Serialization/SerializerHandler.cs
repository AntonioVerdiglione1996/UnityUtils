...
public static class SerializerHandler
{
    ...
    /// </summary>
    /// <param name="directory">directory where file will be.Auto creation if doesn't exist yet.</param>
    ...
    public static void Save(string directory, string filename, string jsonRappresentation)
    {
        ...
        Debug.LogFormat("Serialized at path : {0} , Filename : {1}", Path.Combine(directory, filename), filename);
    }
    /// <summary>
    ...
    public static void RestoreData(string directory, string filename, object objToRestore)
    {
        ...
        Debug.LogFormat("DeSerialized at path : {0} , Filename : {1}", Path.Combine(directory, filename), filename);
    }
}
